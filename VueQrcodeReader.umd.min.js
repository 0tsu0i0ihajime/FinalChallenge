...
let data_uuid,data_json,data_stringify,data_displayName,data_info;
$(function(){
    $.ajax({
      url:"https://raw.githubusercontent.com/0tsu0i0ihajime/testJSON/main/test.json",
      type:"GET",
      dataType:"json",
    })
        .done(function(data){
            ...
            for(t=0;t<Object.keys(data_json).length;t++)local_db.Visitors.put(data_json[t]);
                .then(()=>{
